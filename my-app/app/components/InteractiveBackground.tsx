...
const InteractiveBackground: React.FC = () => {
    ...
    // Define custom platform positions using `u`
    // If `window` is not defined (SSR), use a default width (e.g. 800), so `u = 8`.
    ...
    const resetPlayer = () => {
        ...
        // Safely get scrollY (0 if window not defined)
        const scrollY = typeof window !== 'undefined' ? window.scrollY : 0;

        playerRef.current.reset(50, 50, scrollY);
